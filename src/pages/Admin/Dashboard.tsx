        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-500">이번 주 신규 사용자</p>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-500">이번 주 신규 글</p>
                <p className="text-2xl font-semibold text-gray-900">{stats.newPostsThisWeek}</p>
              </div>
            </div>
          </div>
          ...
          <Link to="/admin/users">
            <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow cursor-pointer">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">사용자 목록 및 권한 관리</p>
              </div>
            </div>
          </Link>
          ...
          <Link to="/admin/posts">
            <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow cursor-pointer">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">글 관리</h3>
                <p className="text-gray-600 text-sm">글 승인 및 관리</p>
              </div>
            </div>
          </Link>
          ...
          <Link to="/admin/comments">
            <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow cursor-pointer">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">댓글 관리</h3>
                <p className="text-gray-600 text-sm">댓글 승인 및 관리</p>
              </div>
            </div>
          </Link>
          ...
          <Link to="/admin/settings">
            <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow cursor-pointer">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">사이트 설정 관리</p>
              </div>
            </div>
          </Link>
        </div>
