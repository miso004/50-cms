      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex items-start justify-between relative">
              ...
              <div className="flex flex-col items-end gap-2">
                ...
                <div className="w-12 h-12 bg-purple-50 rounded-xl flex items-center justify-center">
                  <FontAwesomeIcon icon={faUsers} className="text-purple-500 text-lg" style={{fontWeight: 100, strokeWidth: 0.5}} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 border border-gray-100">
            <div className="flex items-start justify-between relative">
              ...
              <div className="flex flex-col items-end gap-2">
                ...
                <div className="w-12 h-12 bg-purple-50 rounded-xl flex items-center justify-center">
                  <FontAwesomeIcon icon={faFileAlt} className="text-purple-600 text-lg" style={{fontWeight: 100, strokeWidth: 0.5}} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 border border-gray-100">
            <div className="flex items-start justify-between relative">
              ...
              <div className="flex flex-col items-end gap-2">
                ...
                <div className="w-12 h-12 bg-purple-50 rounded-xl flex items-center justify-center">
                  <FontAwesomeIcon icon={faComments} className="text-purple-600 text-lg" style={{fontWeight: 100, strokeWidth: 0.5}} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 border border-gray-100">
            <div className="flex items-start justify-between relative">
              ...
              <div className="flex flex-col items-end gap-2">
                ...
                <div className="w-12 h-12 bg-purple-50 rounded-xl flex items-center justify-center">
                  <FontAwesomeIcon icon={faUserPlus} className="text-purple-600 text-lg" style={{fontWeight: 100, strokeWidth: 0.5}} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 border border-gray-100">
            <div className="flex items-start justify-between relative">
              ...
              <div className="flex flex-col items-end gap-2">
                ...
                <div className="w-12 h-12 bg-purple-50 rounded-xl flex items-center justify-center">
                  <FontAwesomeIcon icon={faEdit} className="text-purple-600 text-lg" style={{fontWeight: 100, strokeWidth: 0.5}} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 border border-gray-100">
            <div className="flex items-start justify-between relative">
              ...
              <div className="flex flex-col items-end gap-2">
                ...
                <div className="w-12 h-12 bg-purple-50 rounded-xl flex items-center justify-center">
                  <FontAwesomeIcon icon={faBolt} className="text-purple-600 text-lg" style={{fontWeight: 100, strokeWidth: 0.5}} />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mb-10 mt-10">
          <div className="flex items-center mb-6">
            <FontAwesomeIcon icon={faCog} className="text-blue-600 text-xl mr-3" style={{fontWeight: 100, strokeWidth: 0.5}} />
            <h2 className="text-xl font-bold text-gray-900">빠른 관리 메뉴</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Link to="/admin/users" className="group">
              <div  className="bg-white rounded-xl border border-gray-100 p-10 text-center shadow-lg hover:shadow-2xl hover:shadow-purple-500/40 transition-all duration-300">
                <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-purple-600 group-hover:from-purple-600 group-hover:to-purple-800 rounded-xl flex items-center justify-center mx-auto mb-4 transition-all duration-300">
                ...
                <button className="w-full bg-gray-50 border border-gray-300 text-gray-700 py-2 px-4 rounded-lg text-sm font-medium group-hover:bg-purple-600 group-hover:text-white group-hover:border-purple-600 transition-all duration-300">
                  바로가기
                </button>
              </div>
            </Link>
            ...
            <Link to="/admin/settings" className="group">
              <div className="bg-white rounded-xl border border-gray-100 p-10 text-center shadow-lg hover:shadow-2xl hover:shadow-purple-500/40 transition-all duration-300">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-2">사이트 관리</h3>
                <p className="text-sm text-gray-600 mb-4">사이트 설정 및 구성</p>
                <button className="w-full bg-gray-50 border border-gray-300 text-gray-700 py-2 px-4 rounded-lg text-sm font-medium group-hover:bg-purple-600 group-hover:text-white group-hover:border-purple-600 transition-all duration-300">
                  바로가기
                </button>
              </div>
